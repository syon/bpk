    ...
    <div class="absolute top-0">
      <div class="flex flex-col w-32 p-4">
        <label>
          ...
          <input v-model="startPointX" type="number" class="border p-2" />
        </label>
        <label>
          <span>startPointY</span>
          <input v-model="startPointY" type="number" class="border p-2" />
        </label>

        <label>
          <span>startHandleX</span>
          <input v-model="startHandleX" type="number" class="border p-2" />
        </label>
        <label>
          <span>startHandleY</span>
          <input v-model="startHandleY" type="number" class="border p-2" />
        </label>

        <label>
          <span>endHandleX</span>
          <input v-model="endHandleX" type="number" class="border p-2" />
        </label>
        <label>
          <span>endHandleY</span>
          <input v-model="endHandleY" type="number" class="border p-2" />
        </label>
